...
struct stNetActorCreate				// 创建角色的信息
{
	...
	GameCharacter*		CreateCha();
	void			SetValue( GameCharacter* pCha );
};
...
struct stNetNPCShow
{
	...
	void			SetNpcShow( GameCharacter* pCha );
};
...
extern void NetChangeChaPart( GameCharacter* pCha, stNetLookInfo &SLookInfo );
