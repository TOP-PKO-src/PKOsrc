...
//
// 操作对象命名
//      角色 GameCharacter *pCha 
//      主角 GameCharacter* pMainCha
//      物件 CSceneItem* pItem
...
/*
	...
	GameCharacter *pCha = SCreateInfo.CreateCha();
		...
		case	enumACTION_MOVE:
			{
				...
				{
					long	lDist;
					GameCharacter	*pCMainCha = CGameScene::GetMainCha();
					if( pCMainCha )
					{
		...
		case	enumACTION_LOOK: // 更新角色外观
			{
				...
				GameCharacter* pCha = CGameApp::GetCurScene()->SearchByID( l_id );
