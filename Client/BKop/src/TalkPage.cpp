...
BOOL CTalkPage::OnInitDialog()
{
	...
	m_pReleaseArray[0]=new CChannelControl(this,"视野");
	m_pReleaseArray[1]=new CChannelControl(this,"世界");
	m_pReleaseArray[2]=new CChannelControl(this,"交易");
	m_pReleaseArray[3]=new CChannelControl(this,"组队(暂无效)");
	m_pReleaseArray[4]=new CChannelControl(this,"公会(暂无效)");
	m_pReleaseArray[5]=new CChannelControl(this,"私聊");
	m_pReleaseArray[6]=new CChannelControl(this,"GM公告");
	m_pReleaseArray[7]=new CChannelControl(this,"QQ会话");
	m_pReleaseArray[8]=new CChannelControl(this,"控制命令");
