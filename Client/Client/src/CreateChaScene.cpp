...
{
    RES_STRING(CL_LANGUAGE_MATCH_35),
    RES_STRING(CL_LANGUAGE_MATCH_36),
    RES_STRING(CL_LANGUAGE_MATCH_37),
    RES_STRING(CL_LANGUAGE_MATCH_38),
};

const char* CCreateChaScene::szCityNames[MAX_CITY_NUM] = 
{
    RES_STRING(CL_LANGUAGE_MATCH_39),
    RES_STRING(CL_LANGUAGE_MATCH_40),
    RES_STRING(CL_LANGUAGE_MATCH_41),
};

const char* CCreateChaScene::szCitiesDescripts[MAX_CITY_NUM] = 
{
	RES_STRING(CL_LANGUAGE_MATCH_42),
	RES_STRING(CL_LANGUAGE_MATCH_43),
	RES_STRING(CL_LANGUAGE_MATCH_44),
};
