...
void CCharacter::SynBeginItemAmphitheater()
{
	...
	{
		WRITE_CHAR(packet, 1);
		WRITE_CHAR(packet, dataPromotion.size());
		...
		WRITE_CHAR(packet, dataRelive.size());
