...
StoneAttrType [17]		=		ITEMATTR_VAL_DEF	--防御
StoneAttrType [18]		=		ITEMATTR_VAL_MXHP	--最大HP
StoneAttrType [19]		=		ITEMATTR_VAL_MXSP	--最大HP
...
STAR_ATTR_Num = 47
STAR_ATTR={}
STAR_ATTR[1]				=	"力量系数加成            "	--力量系数加成             
STAR_ATTR[2]				=	"敏捷系数加成            "	--敏捷系数加成             
STAR_ATTR[3]				=	"专注系数加成            "	--专注系数加成             
STAR_ATTR[4]				=	"体质系数加成            "	--体质系数加成             
STAR_ATTR[5]				=	"精力系数加成            "	--精力系数加成             
STAR_ATTR[6]				=	"幸运系数加成            "	--幸运系数加成             
STAR_ATTR[7]				=	"攻击频率系数加成      "	--攻击频率系数加成       
STAR_ATTR[8]				=	"攻击距离系数加成      "	--攻击距离系数加成       
STAR_ATTR[9]				=	"最小攻击力系数加成   "	--最小攻击力系数加成    
STAR_ATTR[10]				=	"最大攻击力系数加成   "	--最大攻击力系数加成    
STAR_ATTR[11]				=	"防御系数加成            "	--防御系数加成             
STAR_ATTR[12]				=	"最大Hp系数加成         "	--最大Hp系数加成         
STAR_ATTR[13]				=	"最大Sp系数加成         "	--最大Sp系数加成         
STAR_ATTR[14]				=	"闪避率系数加成         "	--闪避率系数加成          
STAR_ATTR[15]				=	"命中率系数加成         "	--命中率系数加成          
STAR_ATTR[16]				=	"爆击率系数加成         "	--爆击率系数加成          
STAR_ATTR[17]				=	"寻宝率系数加成         "	--寻宝率系数加成          
STAR_ATTR[18]				=	"hp恢复速度系数加成   "	--hp恢复速度系数加成   
STAR_ATTR[19]				=	"sp恢复速度系数加成   "	--sp恢复速度系数加成    
STAR_ATTR[20]				=	"移动速度系数加成      "	--移动速度系数加成       
STAR_ATTR[21]				=	"资源采集速度系数加成"	--资源采集速度系数加成 
STAR_ATTR[22]				=	"物理抵抗系数加成      "	--物理抵抗系数加成       
STAR_ATTR[23]				=	"无                           "	--无                            
STAR_ATTR[24]				=	"无                           "	--无                            
STAR_ATTR[25]				=	"无                           "	--无                            
STAR_ATTR[26]				=	"力量常数加成            "	--力量常数加成             
STAR_ATTR[27]				=	"敏捷常数加成            "	--敏捷常数加成             
STAR_ATTR[28]				=	"专注常数加成            "	--专注常数加成             
STAR_ATTR[29]				=	"体质常数加成            "	--体质常数加成             
STAR_ATTR[30]				=	"精力常数加成            "	--精力常数加成             
STAR_ATTR[31]				=	"幸运常数加成            "	--幸运常数加成             
STAR_ATTR[32]				=	"攻击频率常数加成      "	--攻击频率常数加成       
STAR_ATTR[33]				=	"攻击距离常数加成      "	--攻击距离常数加成       
STAR_ATTR[34]				=	"最小攻击力常数加成   "	--最小攻击力常数加成    
STAR_ATTR[35]				=	"最大攻击力常数加成   "	--最大攻击力常数加成    
STAR_ATTR[36]				=	"防御常数加成            "	--防御常数加成             
STAR_ATTR[37]				=	"最大Hp常数加成         "	--最大Hp常数加成         
STAR_ATTR[38]				=	"最大Sp常数加成         "	--最大Sp常数加成         
STAR_ATTR[39]				=	"闪避率常数加成         "	--闪避率常数加成          
STAR_ATTR[40]				=	"命中率常数加成         "	--命中率常数加成          
STAR_ATTR[41]				=	"爆击率常数加成         "	--爆击率常数加成          
STAR_ATTR[42]				=	"寻宝率常数加成         "	--寻宝率常数加成          
STAR_ATTR[43]				=	"hp恢复速度常数加成   "	--hp恢复速度常数加成   
STAR_ATTR[44]				=	"sp恢复速度常数加成   "	--sp恢复速度常数加成    
STAR_ATTR[45]				=	"移动速度常数加成      "	--移动速度常数加成       
STAR_ATTR[46]				=	"资源采集速度常数加成"	--资源采集速度常数加成 
STAR_ATTR[47]				=	"物理抵抗常数加成      "	--物理抵抗常数加成       
--------------------------------------------------------------------字母都他妈是字母
WORD_Num = 52
WORD={}
WORD[1]="A"
...
StoneTpye_ID [17]	=		5750		--黄玉
StoneTpye_ID [18]	=		5751		--赤玉
StoneTpye_ID [19]	=		5752		--青玉
StoneTpye_ID [20]	=		5771		--夏天之灵光							
StoneTpye_ID [21]	=		5772		--洛克之必中
StoneTpye_ID [22]	=		5773		--冰冰之躲闪
StoneTpye_ID [23]	=		5774		--丰烽之抵御
StoneTpye_ID [24]	=		5775		--夏克之强化
...
StoneItemType[23] = { 22,0 }
StoneItemType[24] = { 22,11 }
