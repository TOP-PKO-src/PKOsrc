...
function Sk_Script_ZhiZao( role , Item ) 
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 1 then
		SystemNotice(role ,"学习此技能最少需要1个空位")
		UseItemFailed ( role )
		return
	end
	...
	if el_sklv <star_lv  then 	
		SystemNotice ( role , "需要掌握"..star_lv.."级伐木技能才能阅读该书" ) 
		UseItemFailed ( role )
		return
	end 
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	...
	if a== 0 then 
		SystemNotice ( role , "生活技能点数不足，请尝试完成更多历史任务" ) 
		UseItemFailed ( role )  
		return 
	end 
	if star_lv==1 then
...
function Sk_Script_ZhuZao( role , Item ) 
	...
	if el_sklv <star_lv  then 	
		SystemNotice ( role ,  "需要掌握"..star_lv.."级挖矿技能才能阅读该书" ) 
		UseItemFailed ( role )
		return
	end 
	local Item_CanGet = GetChaFreeBagGridNum ( role )
...
function Sk_Script_PengRen( role , Item ) 
	...
	if el_sklv <star_lv  then 	
		SystemNotice ( role ,  "需要掌握"..star_lv.."级捕鱼技能才能阅读该书" ) 
		UseItemFailed ( role )
		return
	end 
	a = AddChaSkill ( role , sk_add, star_lv , 1 , 1 ) 
...
function Sk_Script_FenJie( role , Item ) 
	...
	if el_sklv <star_lv  then 	
		SystemNotice ( role , "需要掌握"..star_lv.."级打捞技能才能阅读该书" ) 
		UseItemFailed ( role )
		return
	end 
	local Item_CanGet = GetChaFreeBagGridNum ( role )
...
function AddSailSkill ( role , i , sk_add , sailexp_req ) 
	...
	if form_sklv ~= i - 1  then 
		SystemNotice ( role , "这本书无法让你当前的技能等级获得提升" ) 
		UseItemFailed ( role )  
		return 
	end 
	...
	if sail_exp_remain < sailexp_req  then 
		SystemNotice ( role , "剩余航海经验不足，无法提升技能等级，加油修练吧 ！" ) 
		UseItemFailed ( role )  
		return 
	end 
	LG ( "AddSailSkill" , "技能编号 " ,  sk_add , "  技能等级  " , i  ) 
	LG ( "AddSailSkill" , " 原有航海经验  " , sail_exp_remain , "  航海经验消耗 " , sailexp_req ) 
	sail_exp_remain = sail_exp_remain - sailexp_req 
	LG ( "AddSailSkill" , " 剩余航海经验  " , sail_exp_remain ) 

	SetCharaAttr ( sail_exp_remain , role , ATTR_CLEFT_SAILEXP ) 
	SystemNotice ( role , "消耗航海经验" .. sailexp_req ) 
...
function ItemUse_Wood ( role , Item ) 
	...
	if k == 0 then 
		UseItemFailed ( role ) 
		SystemNotice ( role , "该物品只可在船只航行时使用" )
		return 
	end 
	local hp = GetChaAttr ( role , ATTR_HP ) 
	local mxhp = GetChaAttr ( role, ATTR_MXHP ) 
	if hp < 0 then 
		UseItemFailed ( role ) 
		SystemNotice ( role , "船只已沉没，无法使用物品" ) 
	end 
	local statelv = 1
	local statetime = 63
...
function ItemUse_PKWDYS ( role , Item )
	...
	local cha_name = GetChaDefaultName ( role ) 
	local message = cha_name.."进入无敌状态15秒"  
	Notice ( message )
end
...
function ItemUse_PKMCK ( role , Item )
	...
	if map_name == "secretgarden" then
		...
		SystemNotice ( role , "该物品只有在竞技花园使用才会有效" )
	end
end
...
function ItemUse_MoreExpGzLv2( role , Item )
	local Lv = Lv( role )
	if Lv < 40 then
		SystemNotice(role ,"等级不足40级不可以使用")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_MoreItemAndExpGz( role , Item )
	local Lv = Lv( role )
	if Lv < 30 then
		SystemNotice(role ,"等级不足30级不可以使用")
		UseItemFailed ( role )
		return
	end
...
--	SystemNotice ( role , "属性点修改前应为"..ap )
	...
	SystemNotice ( role , "减少一点力量，增加一点属性点" )
--	SystemNotice ( role , "力量修改后应为"..str )
--	SystemNotice ( role , "属性点修改后应为"..ap )
	SetCharaAttr ( str , role , ATTR_BSTR )
	SetCharaAttr ( ap , role , ATTR_AP )
...
--	SystemNotice ( role , "属性点修改前应为"..ap )
	...
	SystemNotice ( role , "减少一点体质，增加一点属性点" )
...
--	SystemNotice ( role , "属性点修改前应为"..ap )
	...
	SystemNotice ( role , "减少一点敏捷，增加一点属性点" )
...
--	SystemNotice ( role , "属性点修改前应为"..ap )
	...
	SystemNotice ( role , "减少一点专注，增加一点属性点" )
...
--	SystemNotice ( role , "属性点修改前应为"..ap )
	...
	SystemNotice ( role , "减少一点精神，增加一点属性点" )
...
--	end
	...
	if ItemId == 878 then
		local itemname = GetItemName ( ItemId ) 
		local cha_name = GetChaDefaultName ( role ) 
		local message = cha_name.."打开富贵包惊喜地获得"..itemname  
		Notice ( message )
	end
end 
...
--	end
	...
	for Good_C = 0 , 6 , 1 do
		if ItemId == GoodItem[Good_C] then
			local itemname = GetItemName ( ItemId ) 
			local cha_name = GetChaDefaultName ( role ) 
			local message = cha_name.."打开鸿运包惊喜地获得"..itemname  
			Notice ( message )
		end
	end
end 
...
--	end
	...
	for Good_C = 0 , 21 , 1 do
		if ItemId == GoodItem[Good_C] then
			local itemname = GetItemName ( ItemId ) 
			local cha_name = GetChaDefaultName ( role ) 
			local message = cha_name.."使用闪光的许愿石惊喜地获得"..itemname  
			Notice ( message )
		end
	end
end 
...
function ItemUse_JingLingBOX ( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，精灵礼品盒开启失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_SaintCloth ( role , Item ) 
	...
	if Item_CanGet <= 3 then
		SystemNotice(role ,"身上没有4格的剩余空间，年兽宝箱开启失败～")
		UseItemFailed ( role )
		return
	end
	if cha_type == 4 then 
...
function ItemUse_SCBoxYXTZ ( role , Item )		--夜行套装
	...
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有3格的剩余空间，宝箱开启失败～")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_SCBoxLSTZ ( role , Item )		--力士套装
	...
	if Item_CanGet <= 3 then
		SystemNotice(role ,"身上没有足够的剩余空间，宝箱开启失败～")
		UseItemFailed ( role )
		return
	end
	if cha_type == 2 then
...
function ItemUse_SCBoxFYSTZ ( role , Item )		--封印职业套装
	...
	if Item_CanGet <= 3 then
		SystemNotice(role ,"身上没有4格的剩余空间，宝箱开启失败～")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_SCBoxRYBZ ( role , Item )		--如意宝杖
	...
	if Item_CanGet == 0 then
		SystemNotice(role ,"身上没有剩余空间，宝箱开启失败～")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_Map_JLBYPJ( role , Item )
	...
	if lv <15 or  lv >40 then
		SystemNotice ( role , "角色当前级别低于15级或高于40级不能使用新式羊皮卷" )
		UseItemFailed ( role )
		return	
	end
...
function ItemUse_JLB_GoldenMap ( role , Item )
	...
	local lv= GetChaAttr(role, ATTR_LV) 
	if lv <15 or  lv >40 then
		SystemNotice ( role , "角色当前级别低于15级或高于40级不能使用藏宝图" )
		UseItemFailed ( role )
		return	
	end
	local Has_GoldenMap = CheckBagItem ( role , 682 )
	if Has_GoldenMap >= 2 then
		SystemNotice ( role , "想要挖宝身上只能带一张藏宝图，多余的藏宝图可以暂时存放到银行里" )
		UseItemFailed ( role )
		return
	end
...
--	SystemNotice( role , Cha_Boat )
	if Cha_Boat ==  nil then
		...
		if exp < clexp then
			SystemNotice ( role , "经验低于当前级别所需经验，不能抽签。" )
			UseItemFailed ( role )
			return
		end
...
--	SystemNotice( role , Cha_Boat )
	if Cha_Boat ~= nil then 
		...
		if Item_type == 58 and Item_Traget_Type == 59 then
				...
				if Check_Exp == 0 then
					SystemNotice(role , "成长度没有达到最大不能喂食圣雪山龙果" ) 
					UseItemFailed ( role )
				else
...
--	SystemNotice( role , Cha_Boat )
	if Cha_Boat ~= nil then 
		...
		if Item_type == 58 and Item_Traget_Type == 59 then
				Check_Exp = CheckElf_EXP ( role , Item_Traget ) --精灵exp是否满足升级条件
				if Check_Exp == 0 then
					SystemNotice(role , "成长度没有达到最大不能喂食冰极爽口梅" ) 
					UseItemFailed ( role )
				else
...
--	SystemNotice( role , Cha_Boat )
	if Cha_Boat ~= nil then 
		...
		if Item_type == 58 and Item_Traget_Type == 59  then
				Check_Exp = CheckElf_EXP ( role , Item_Traget ) --精灵exp是否满足升级条件
				if Check_Exp == 0 then
					SystemNotice(role , "成长度没有达到最大不能喂食海风鳕鱼丝" ) 
					UseItemFailed ( role )
				else
...
--	SystemNotice( role , Cha_Boat )
	if Cha_Boat ~= nil then 
		...
		if Item_type == 58 and Item_Traget_Type == 59 then
				Check_Exp = CheckElf_EXP ( role , Item_Traget ) --精灵exp是否满足升级条件
				if Check_Exp == 0 then
					SystemNotice(role , "成长度没有达到最大不能喂食白银城果脯" ) 
					UseItemFailed ( role )
				else
...
--	SystemNotice( role , Cha_Boat )
	if Cha_Boat ~= nil then 
		...
		if Item_type == 58 and Item_Traget_Type == 59  then
				Check_Exp = CheckElf_EXP ( role , Item_Traget ) --精灵exp是否满足升级条件
				if Check_Exp == 0 then
					SystemNotice(role , "成长度没有达到最大不能喂食新沙岚米饼" ) 
					UseItemFailed ( role )
				else
...
function ItemUse_MINGZJLD ( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用命之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_FAZJLD ( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用罚之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_QIANZJLD ( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用谦之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_HENGZJLD( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用恒之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_YUZJLD( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用誉之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_XUEZJLD( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用血之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_XINGZJLD ( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用信之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_HUIZJLD( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用悔之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_AIZJLD ( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用爱之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_XINGZHIJLD ( role, Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用心之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
--	return
	...
	if Item_CanGet < 5 then
		SystemNotice(role ,"要打开新人宝箱需要背包里至少有5个空位")
		UseItemFailed ( role )
		return
	end
	if lv < 5 then
...
function ItemUse_SANWUBOX( role, Item )
	...
	if Item_CanGet < 4 then
		SystemNotice(role ,"要打开新人宝箱需要背包里至少有4个空位")
		UseItemFailed ( role )
		return
	end
	if lv < 10 then
...
function ItemUse_WUWUBOX( role, Item )
	...
	if lv < 45 then
		SystemNotice(role ,"当前级别低于45级，道具使用失败！")
		UseItemFailed ( role )
		return
	end
	if cha_type == 1 and job==9 then
...
function ItemUse_LIUWUBOX( role, Item )
	...
	if lv < 55 then
		SystemNotice(role ,"当前级别低于55级，道具使用失败！")
		UseItemFailed ( role )
		return
	end
	if cha_type == 1 and job==9 then
...
function ItemUse_XRBOX1( role, Item )
	...
	if Item_CanGet < 7 then
		SystemNotice(role ,"要打开新人宝箱需要背包里至少有7个空位")
		UseItemFailed ( role )
		return
	end
	if lv < 10 then
	...
	elseif job == 5 then   
		...
		SystemNotice(role ,"职业不符，道具需在新手转职后方可使用！")
		UseItemFailed ( role )	
	end
end
----------------------------------+2新人宝箱
function ItemUse_XRBOX2( role, Item )
	...
	if Item_CanGet < 6 then
		SystemNotice(role ,"要打开新人宝箱需要背包里至少有6个空位")
		UseItemFailed ( role )
		return
	end
	if lv < 15 then
...
function ItemUse_XRBOX3( role, Item )
	...
	if lv < 20 then
		SystemNotice(role ,"当前级别低于20级，道具使用失败！")
		UseItemFailed ( role )	
	elseif job == 1 then  
...
function ItemUse_XRBOX6( role, Item )
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet < 2 then
		SystemNotice(role ,"要打开新人宝箱需要背包里至少有2个空位")
		UseItemFailed ( role )
		return
	end
	if lv < 35 then
...
function ItemUse_XRBOX7( role, Item )
	...
	elseif job == 14 then    
		...
		SystemNotice(role ,"职业不符，二转就职后方可打开！")
		UseItemFailed ( role )	
	end
end
-------------------------------------------------------- --[[粽子公式]]--
...
function ItemUse_FLeiBOX( role , Item )
	...
	if Item_CanGet < BNUM then
		SystemNotice(role ,"要打开风雷宝箱需要背包里至少有"..BNUM.."个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_YZheBOX( role , Item )
	...
	if Item_CanGet < 8 then
		SystemNotice(role ,"要打开勇者宝箱需要背包里至少有8个空位")
		UseItemFailed ( role )
		return
	end
...
--	SystemNotice( role , Cha_Boat )
	...
	SystemNotice ( role ,"感受到高级努力增幅器效果" )
end
...
function ItemUse_MoreItemGzLv3A( role , Item )
	...
	SystemNotice ( role ,"感受到高级财富增幅器效果" )
end
-------------------------------------强力体力恢复剂
...
function ItemUse_CiChang( role, Item )
	...
	if Elf_EXP >9 then
		SystemNotice(role ,"诅咒点数超过9，无法开启宝箱")
		UseItemFailed ( role )
		return
	end
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	...
	if sta == 1 then ---核心一866黑龙之心----------给黑龙之躯
		...
		local message ="黑龙祭坛赐福于".. cha_name.."惊喜地获得黑龙之躯"  
		Notice ( message )
		LG("HeiLongJiTan","角色名为",cha_name,"的玩家在诅咒点为",Elf_EXP,"的情况下打开黑龙祭坛获得道具黑龙之躯")
	end
	if sta == 2 then ---核心二865黑龙之魂---------------给黑龙之翼
		...
		local message ="黑龙祭坛赐福于".. cha_name.."惊喜地获得黑龙之翼"  
		Notice ( message )
		LG("HeiLongJiTan","角色名为",cha_name,"的玩家在诅咒点为",Elf_EXP,"的情况下打开黑龙祭坛获得道具黑龙之翼")
	end
	if sta == 3 then ---核心三864黑龙之瞳---------------给黑龙之爪
		...
		local message ="黑龙祭坛赐福于".. cha_name.."惊喜地获得黑龙之爪"  
		Notice ( message )
		LG("HeiLongJiTan","角色名为",cha_name,"的玩家在诅咒点为",Elf_EXP,"的情况下打开黑龙祭坛获得道具黑龙之爪")
	end
	if sta == 4 then ---核心三给黑龙之首
		...
		local message ="黑龙祭坛赐福于".. cha_name.."惊喜地获得黑龙之首"  
		Notice ( message )
		LG("HeiLongJiTan","角色名为",cha_name,"的玩家在诅咒点为",Elf_EXP,"的情况下打开黑龙祭坛获得道具黑龙之首")
	end
	if Elf_EXP ~=0 then
		SystemNotice(role ,"存在的诅咒点使黑龙装备质量受损")
	end
end
...
function ItemUse_hexin ( role , Item , Item_Traget ) 
	...
	if sta==1 and Item_ID == 866 then
		SystemNotice(role ,"您已经使用了黑龙之心作为祭品")
		UseItemFailed ( role )
		return	
	end
	if sta==2 and Item_ID == 865 then
		SystemNotice(role ,"您已经使用了黑龙之魂作为祭品")
		UseItemFailed ( role )
		return	
	end
	if sta==3 and Item_ID == 864 then
		SystemNotice(role ,"您已经使用了黑龙之瞳作为祭品")
		UseItemFailed ( role )
		return	
	end
	local Cha_Boat = 0
	...
	if Cha_Boat ~= nil then 
		...
		if Item_type == 49 and Item_Traget_Type == 65 then
				...
				sta =1
				SystemNotice( role , "使用黑龙之心作为祭品可获得装备--黑龙之躯" )
				LG("HeiLongJiTan_HeXin","角色名为",cha_name,"的玩家使用黑龙之心作为祭品")
				elseif Item_ID == 865 then						---核心B
				sta =2
				SystemNotice( role , "使用黑龙之魂作为祭品可获得装备--黑龙之翼" )
				LG("HeiLongJiTan_HeXin","角色名为",cha_name,"的玩家使用黑龙之魂作为祭品")
				elseif Item_ID == 864 then						---核心C
				sta =3
				SystemNotice( role , "使用黑龙之瞳作为祭品可获得装备--黑龙之爪" )
				LG("HeiLongJiTan_HeXin","角色名为",cha_name,"的玩家使用黑龙之瞳作为祭品")
	...
	if Cha_Boat ~= nil then 
		...
		if Item_type == 66 and Item_Traget_Type == 65  then
				...
				local Elf_EXP = GetItemAttr(Item_Traget,ITEMATTR_ENERGY) --最大能量记录诅咒点数
					...
					Elf_EXP = Elf_EXP + 1
					SystemNotice( role , "祭坛不幸被黑龙的鬼魂诅咒" ) 
...
function ItemUse_ZhuFu ( role , Item , Item_Traget ) 
	...
	if Elf_EXP <= 5 and Elf_EXP >= 1 then
		if rad <= 30 then
			...
			SystemNotice(role ,"由于您刚才使用的天使骰子质量太差,诅咒并没有解除")
		end
	end
			...
			--	end
				...
				for Good_C = 0 , 14 , 1 do
					if ItemId == GoodItem[Good_C] then
						local itemname = GetItemName ( ItemId ) 
						local cha_name = GetChaDefaultName ( role ) 
						local message = cha_name.."打开一元好运包惊喜地获得"..itemname  
						Notice ( message )
					end
				end
			end 
...
local Item_CanGet = GetChaFreeBagGridNum ( role )
	...
	GiveItem ( role , 0 , 847  , 1 , 16  ) 
	local cha_name = GetChaDefaultName ( role ) 
	local message = cha_name.."打开特等奖惊喜地获得黑龙套装"
		Notice ( message )
end
...
local Item_CanGet = GetChaFreeBagGridNum ( role )
	...
	local cha_name = GetChaDefaultName ( role ) 
	local message = cha_name.."打开一等奖惊喜地获得假期欢乐杂志" 
		Notice ( message )
end
...
local Item_CanGet = GetChaFreeBagGridNum ( role )
	...
	local cha_name = GetChaDefaultName ( role ) 
	local message = cha_name.."打开二等奖惊喜地获得强化晶石10个和摩力酷装1套"   
		Notice ( message )
end
...
function ItemUse_BaoZhaBOX ( role , Item )
	...
	if Money_Have>1900000000 then
		SystemNotice (role, "带的钱不要超过19亿哦，钱多了不太安全吧")
		return 
	end
	AddMoney ( role , 0 , 10000 )                 --------10000海盗币
		SystemNotice ( role ,"恭喜您获得10000海盗币的惠赠")	
end
...
function ItemUse_Crbbt(role, Item )
	SystemNotice(role ,"该物品因放置过久而过期失效,不要太失落哦")
--	local statelv = 1
--	local statetime = 20
...
function ItemUse_ZhouSuiBOX ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet < 2 then
		SystemNotice(role ,"身上没有足够的空间，生日包开启失败")
		UseItemFailed ( role )
		return
	end
	...
	if ItemId ==  0853 then
	local cha_name = GetChaDefaultName ( role ) 
	local message = cha_name.."打开周岁生日宝箱惊喜地获得假期欢乐杂志" 
	Notice ( message )
	end
end
-------------------------------百万大钞ItemUse_CZHe
...
function ItemUse_YZJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用运之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_TZJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用体之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
	local Num_newJL = GetItemForgeParam ( Item , 1 )
...
function ItemUse_LZJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用力之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
	local Num_newJL = GetItemForgeParam ( Item , 1 )
...
function ItemUse_SZJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用神之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
	local Num_newJL = GetItemForgeParam ( Item , 1 )
...
function ItemUse_ZZJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用专之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
	local Num_newJL = GetItemForgeParam ( Item , 1 )
...
function ItemUse_MZJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用敏之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
	local Num_newJL = GetItemForgeParam ( Item , 1 )
...
function ItemUse_XZJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用邪之精灵蛋失败")
		UseItemFailed ( role )
		return
	end
	local Num_newJL = GetItemForgeParam ( Item , 1 )
...
function ItemUse_MDXZESJLD( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用摩豆精灵蛋失败")
		UseItemFailed ( role )
		return
	end
	local new_str=GetItemAttr ( Item , ITEMATTR_VAL_STR )      
...
function ItemUse_70FYZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用70级封印紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70JJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用70级巨剑紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70SJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用70级双剑紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70JUJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用70级狙击紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70HHZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用70级航海紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70SZZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用70级圣职紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50SJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级双剑宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60SJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级双剑宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70SJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级双剑宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50JJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级巨剑宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60JJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级巨剑宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70JJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级巨剑宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50SZBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级圣职宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60SZBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级圣职宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70SZBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级圣职宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50AMSZBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级艾米圣职宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60AMSZBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级艾米圣职宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70AMSZBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级艾米圣职宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50AMFYBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级艾米封印宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60AMFYBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级艾米封印宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70AMFYBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级艾米封印宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50AMHHBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级艾米航海宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60AMHHBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级艾米航海宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70AMHHBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级艾米航海宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50JUJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级狙击宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60JUJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级狙击宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70JUJBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级狙击宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50HHBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级航海宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60HHBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级航海宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70HHBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级航海宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50FYBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级封印宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60FYBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级封印宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_70FYBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 2 then
		SystemNotice(role ,"身上没有足够的空间，使用70级封印宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_lieyanBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用烈炎石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_zhiyanBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用炙焰石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_huoyaoBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用火药石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_manaoBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用玛瑙石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_shengguangBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用圣光石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_yuezhixinBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用月之心兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_hanyuBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用寒玉兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_fenglingBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用风灵石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_xianlingBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用仙灵石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_yingyanBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用鹰眼石兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_yanyuBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用岩玉兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_tanyuBook( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用炎玉兑换券失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50SJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级双剑紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50JJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级巨剑紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50JUJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级狙击紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50HHZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级航海紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50SZZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级圣职紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_50FYZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用50级封印紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60SJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级双剑紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60JJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级巨剑紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60JUJZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级狙击紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60HHZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级航海紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60SZZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级圣职紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_60FYZWBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，使用60级封印紫武宝箱失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_NSDXB ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，女神的小包开启失败")
		UseItemFailed ( role )
		return
	end
	...
	local cha_name = GetChaDefaultName ( role ) 
	local message = cha_name.."打开女神的小包惊喜地获得"..itemname  
	Notice ( message )
end
----加纳宝箱
function ItemUse_JaNaBox ( role , Item ) 
	...
	local cha_name = GetChaDefaultName ( role ) 
	local message = cha_name.."打开加纳宝箱惊喜地获得"..itemname  
	Notice ( message )
end
...
function gogogo(role,Item,item_type,item_type_rad,item_type_count,maxitem,item_quality)
	...
	for Good_C = 0 , 4 , 1 do
		if ItemId == GoodItem[Good_C] then
			local itemname = GetItemName ( ItemId ) 
			local message = cha_name.."打开黑市装备惊喜地获得"..itemname  
			Notice ( message )
		end
	end
...
function ItemUse_minibh( role , Item )
	...
	if star==1 then
		...
		local message = cha_name.."打开迷你黑龙包惊喜地获得特等奖 黑龙套装一套" 
		Notice ( message )
	elseif star>1 and star<=51 then
		GiveItem ( role , 0 , 273  , 1 , 4  ) 
		local message1 = cha_name.."打开迷你黑龙包惊喜地获得一等奖 假期欢乐杂志一本" 
		Notice ( message1 )
...
function ItemUse_mohuan( role , Item )
	...
	if star<=8 then
		...
		local message = cha_name.."打开魔幻女神卡惊喜地获得 女神试炼仪式" 
		Notice ( message )
	elseif star>=9 and star<=17 then
		GiveItem ( role , 0 , 271, 1 , 4  ) 
		local message1 = cha_name.."打开魔幻女神卡惊喜地获得 天使骰子" 
		Notice ( message1 )
	elseif star>=18 and star<=27 then
		GiveItem ( role , 0 , 1012, 1 , 4  ) 
		local message3 = cha_name.."打开魔幻女神卡惊喜地获得 加纳之神" 
		Notice ( message3 )
...
function ItemUse_MHDTZ( role , Item ) 							
 	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 1 then
		SystemNotice(role ,"打开模糊的图纸最少需要1个空位")
		UseItemFailed ( role )
		return
	end  	
	local r1 = 0
	...
	--SystemNotice(role ,"图纸等级energy=="..energy)
...
function ItemUse_FightingBox( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 2 then
		SystemNotice(role ,"打开乱斗宝盒最少需要2个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_XUEYU( role , Item ) 
	...
	if ChaStateLv > statelv then
		SystemNotice ( role , "已使用更高级的同类物品，请稍候再用" )
		UseItemFailed ( role )
		return
	end
	local statetime = 900
...
function ItemUse_IDBOX(role, Item )
	...
	if lv < 60 then
		SystemNotice( role ,"当前级别低于60级，道具使用失败！")
		UseItemFailed ( role )	
	else
		SystemNotice(role,"活动已结束，谢谢您的参与，请关注海盗王官方网站来获得更多活动机会！")
	end
end 
...
function ItemUse_GWZHQ ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <=3 then
		SystemNotice(role ,"身上没有足够的空间，至少要有4个空位，使用精美的圣诞礼盒失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_HJZHQ ( role , Item  )
	...
	local pet_num = GetPetNum(role)
	if pet_num >= 5 then
		SystemNotice( role , "宠物已满5只,请稍候再召唤!" )
		UseItemFailed ( role )
		return
	end
	local x, y = GetChaPos(role)
...
function ItemUse_SDDLB ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <=5 then
		SystemNotice(role ,"身上没有足够的空间，至少要有6个空位，使用精美的圣诞礼盒失败")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_XINBOX ( role , Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，礼炮使用失败")
		UseItemFailed ( role )
		return
	end
	for i = 1 , maxitem , 1 do 
	...
	for Good_C = 0 , 19 , 1 do
		if ItemId == GoodItem[Good_C] then
			local itemname = GetItemName ( ItemId ) 
			local cha_name = GetChaDefaultName ( role ) 
			local message = cha_name.."使用礼炮惊喜地获得"..itemname  
			Notice ( message )
		end
	end
end
...
function ItemUse_XNBOX( role , Item )
	...
	if Item_CanGet < 1 then
		SystemNotice(role ,"打开宝箱背包里至少需要有1个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_SZF ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet <1 then
		SystemNotice(role ,"身上没有足够的空间，至少要有1个空位，使用海盗兑换券8失败")
		UseItemFailed ( role )
		return
	end
	GiveItem ( role , 0 , 2306  , 1 , 4)
	local cha_name = GetChaDefaultName ( role ) 
			local message ="恭喜" ..cha_name.."获得价值3千元人民币的IPOD奖品" 
			Notice ( message )
...
function ItemUse_LoveBox( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 1 then
		SystemNotice(role ,"打开情缘宝盒最少需要1个空位")
		UseItemFailed ( role )
		return
	end
	local cha_type = GetChaTypeID ( role ) 
...
function ItemUse_MarryBox ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"使用礼服宝箱最少需要4个空位")
		UseItemFailed ( role )
		return
	end
	local cha_type = GetChaTypeID ( role ) 
...
function ItemUse_JRDQBox( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 10 then
		SystemNotice(role ,"打开佳人动情礼盒最少需要10个空位")
		UseItemFailed ( role )
		return
	end
	local cha_type = GetChaTypeID ( role ) 
	 if cha_type ==1 or cha_type ==2 then
	 SystemNotice(role ,"佳人动情礼盒只有女性角色可以打开")
	UseItemFailed ( role )
		return
	end 
...
function ItemUse_CJDQBox( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 10 then
		SystemNotice(role ,"打开才俊动情礼盒最少需要10个空位")
		UseItemFailed ( role )
		return
	end
	local cha_type = GetChaTypeID ( role ) 
	 if cha_type ==3 or cha_type ==4 then
		SystemNotice(role ,"才俊动情礼盒只有男性角色可以打开")
		UseItemFailed ( role )
		return
	end
	local el = math.random ( 1, 100 )
...
function ItemUse_XTBOX ( role , Item )
	...
	if Item_CanGet <= 0 then
		SystemNotice(role ,"身上没有足够的空间，喜糖使用失败")
		UseItemFailed ( role )
		return
	end
	for i = 1 , maxitem , 1 do 
	...
	for Good_C = 0 , 19 , 1 do
		if ItemId == GoodItem[Good_C] then
			local itemname = GetItemName ( ItemId ) 
			local cha_name = GetChaDefaultName ( role ) 
			local message = cha_name.."使用喜糖惊喜地获得"..itemname  
			Notice ( message )
		end
	end
end
...
function ItemUse_HQBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"打开婚庆大礼盒最少需要4个空位")
		UseItemFailed ( role )
		return
	end
	local el = math.random ( 1, 100 )
...
function ItemUse_XYPIGBOX( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 1 then
		SystemNotice(role ,"打开幸运猪宝箱最少需要1个空位")
		UseItemFailed ( role )
		return
	end
	local el = math.random ( 1, 100 )
...
function ItemUse_Hadisi( role , Item )		----------哈迪斯遗物
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"打开哈迪斯遗物最少需要3个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_Anhei( role , Item )		----------暗黑盒子
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"打开暗黑盒子最少需要3个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_Diyu( role , Item )		----------地狱包袱
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"打开地狱包袱最少需要3个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_Xiuluo( role , Item )		----------修罗箱子
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"打开修罗箱子最少需要3个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_Youming( role , Item )	----------幽冥宝藏
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"打开幽冥宝藏最少需要3个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_Minghe( role , Item )		----------冥河小包
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"打开冥河小包最少需要3个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_Sishen( role , Item )		----------死神藏尸处
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 2 then
		SystemNotice(role ,"打开死神藏尸处最少需要1个空位")
		UseItemFailed ( role )
		return
	end
	local job = GetChaAttr(role, ATTR_JOB)
...
function ItemUse_Zhenheilong( role , Item )	----------真黑龙宝箱
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 5 then
		SystemNotice(role ,"打开真黑龙宝箱最少需要4个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_DathBagA(role, Item )
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 2 then
		SystemNotice(role ,"打开死神的行囊最少需要1个空位")
		UseItemFailed ( role )
		return
	end
...
function ItemUse_ZSCard(role, Item )
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	if Item_CanGet < 1 then
		SystemNotice(role ,"使用转生卡最少需要1个空位")
		UseItemFailed ( role )
		return
	end
	if k == 0 then
		if i > 0 then
			...
			if j == 1 then
				SystemNotice(role, "使用转生卡成功，您现在可以和旁边的转生天使对话直接进行转生")
...
local Cha_Boat = 0
   ...
   elseif map_name_role == "guildwar2" then 
	...
	SetChaSideID(new,2)
        ...
        SystemNotice( role , "此召唤券只能在圣战地图中使用" )
        UseItemFailed ( role )
        return
    end
...
--local k = ChaIsBoat(role)
 ...
 if GetChaGuildID(role) == 0 then
    SystemNotice( role , "你没有公会无法使用此机票" )
    UseItemFailed ( role )
    return
 end
...
elseif map_name_role =="guildwar2" then
	 ...
	 elseif GetChaGuildID(role) > 100 and GetChaGuildID(role) <= 200 and map_name_role =="guildwar2"  then
        ...
        SystemNotice( role , "此机票只能在圣战地图中使用" )
        UseItemFailed ( role )
        return
   end        
end
...
function ItemUse_CZBox ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"使用白羊酷装宝箱最少需要4个空位")
		UseItemFailed ( role )
		return
	end
	local cha_type = GetChaTypeID ( role ) 
...
function ItemUse_NiceCake (role, Item )
	...
	local el_fame = GetChaAttr(role, ATTR_FAME)
		...
		SystemNotice( role , "您身上的荣誉值或声望值过高，该品牌蛋糕已经不能满足您了")
		UseItemFailed ( role )
		end
end
...
function ItemUse_TJQ ( role , Item )
	local lv= GetChaAttr(role, ATTR_LV) 
	if lv >70 then
		SystemNotice ( role , "70级以上角色不能使用该升级推进器" )
		UseItemFailed ( role )
		return	
	end
	local statelv = 5
	local ChaStateLv = GetChaStateLv ( role , STATE_SBJYGZ )
	if ChaStateLv > statelv then
		SystemNotice ( role , "已使用更高级的升级道具,请稍候再用" )
		UseItemFailed ( role )
		return
	end
	local statetime = 1800
...
function ItemUse_JNCZBox ( role , Item )
	local Item_CanGet = GetChaFreeBagGridNum ( role )
	 if Item_CanGet < 4 then
		SystemNotice(role ,"使用金牛酷装宝箱最少需要4个空位")
		UseItemFailed ( role )
		return
	end
	local cha_type = GetChaTypeID ( role ) 
...
function ItemUse_CJZTQ ( role , Item )
	local lv= GetChaAttr(role, ATTR_LV) 
	if lv >49 then
		SystemNotice ( role , "49级以上角色不能使用该超级助推器" )
		UseItemFailed ( role )
		return	
	end
	local statelv = 6
...
function ItemUse_JSZSCP( role , Item )
	...
	if  star==1 then
		...
		local cha_name = GetChaDefaultName ( role ) 
		local message = "玩家"..cha_name.."人品爆发,打开惊世转生彩票惊喜地获得1张转生卡." 
		Notice ( message )
	elseif star>1 and star<=10 then
		GiveItem ( role , 0 , 3016, 1 , 4  ) 
		local cha_name = GetChaDefaultName ( role ) 
		local message = "玩家"..cha_name.."人品爆发,打开惊世转生彩票惊喜地获得1张黑龙幻体召唤卷." 
		Notice ( message )
...
function ItemUse_superBOX ( role , Item )
	...
	local Item_CanGet = GetChaFreeBagGridNum ( role )	
	if Item_CanGet < 1 then
		SystemNotice(role ,"打开超人宝箱至少需要1个空位")
		UseItemFailed ( role )
		return
	end
	local cha_name = GetChaDefaultName ( role ) 
...
function ItemUse_ALDXB ( role )
	...
	--SystemNotice(role ,"star=="..star)
		...
		elseif star>=19301 and star<=19600then
			...
			if el1==1  then
				GiveItem ( role , 0 , 0863  , 1 , 4 )
				local message = cha_name.."打开阿拉丁小包,得到了炎玉" 
				Notice ( message )
			elseif el1==2 then
				GiveItem ( role , 0 , 0860  , 1 , 4 )
				local message1 = cha_name.."打开阿拉丁小包,得到了风灵石" 
				Notice ( message1 )
			elseif el1==3 then
				GiveItem ( role , 0 , 0861  , 1 , 4 )
				local message2 = cha_name.."打开阿拉丁小包,得到了鹰眼石" 
				Notice ( message2 )
			elseif el1==4 then
				GiveItem ( role , 0 , 0862  , 1 , 4 )
				local message3 = cha_name.."打开阿拉丁小包,得到了岩玉" 
				Notice ( message3 )
			elseif el1==5 then
				GiveItem ( role , 0 , 1012  , 1 , 4 )
				local message4 = cha_name.."打开阿拉丁小包,得到了炎玉加纳之神" 
				Notice ( message4 )
			end

		elseif star==19601 then
			GiveItem ( role , 0 , 0192  , 1 , 4  )
			local message8= cha_name.."打开阿拉丁小包,得到了年兽宝箱" 
			Notice ( message8 )

		elseif star>=19601 and star<=20000 then	
			GiveItem ( role , 0 , 2224  , 1 , 4  )
			local message8= cha_name.."打开阿拉丁小包,得到了新式摩力酷装宝箱" 
			Notice ( message8 )
		end
...
function ItemUse_springgiftA (role, Item)
	...
	local item_name = ""
	if  sc <=60 then	
		GiveItem ( role , 0 , 3094 , 5 , 4 )                      ---------------努力增幅器   获得机率60%
		item_name = "努力增幅器"
	elseif sc <=76 then		
		GiveItem ( role , 0 , 0849 , 5 , 4 )                      ---------------组队经验果   获得机率16%
		item_name = "组队经验果"
	elseif sc <=86 then
		GiveItem ( role , 0 , 3096 , 5 , 4 )                      ---------------财富增幅器   获得机率10%
		item_name = "财富增幅器"
	elseif sc <=91 then
...
function ItemUse_moliimm ( role , Item )
	local lv= GetChaAttr(role, ATTR_LV) 
	if lv >49 then
		SystemNotice ( role , "49级以上角色不能使用该摩力神仙果" )
		UseItemFailed ( role )
		return	
	end
	local statelv = 5
...
function ItemUse_molibless ( role , Item )
	local lv= GetChaAttr(role, ATTR_LV) 
	if lv > 75  then
		SystemNotice ( role , "70级以上角色不能使用摩力祝福果！" )
		UseItemFailed ( role )
		return	
	end
...
--	SystemNotice( role , Cha_Boat )
	...
	SystemNotice ( role ,"感受到神佑努力果的效果,半小时内可获得3倍打怪经验喔" )
end
...
function ItemUse_lv2swbzbox (role, Item)
	...
	elseif sc <=40 then
		...
		itemname = "青龙钥匙"
	elseif sc <=70 then
		GiveItem ( role , 0 , 0578 , 1 , 4 )                    ---------------加速成长果   获得机率30%
		itemname = "加速成长果"
	elseif sc <=90 then
...
function ItemUse_YSYS(role, Item )
	...
	local statelv = 1
	local statetime = 30000
	local  statetime2 = 60000
...
---------------核心2使用-----------------------sta = GetItemAttr( Item_Traget ,ITEMATTR_VAL_STA )       --精神
...
--------------赫拉神符使用--------------------------str = GetItemAttr( Item_Traget ,ITEMATTR_VAL_STR )       --力量
...
---------------雅典娜神符使用-------------------------con = GetItemAttr( Item_Traget ,ITEMATTR_VAL_CON )       --体质
...
----------------阿波罗神符使用---------------------------agi = GetItemAttr( Item_Traget ,ITEMATTR_VAL_AGI )       --敏捷
...
----------------丘比特神符使用---------------------------dex = GetItemAttr( Item_Traget ,ITEMATTR_VAL_DEX )       --专注
...
function 	ItemUse_chunjunbox (role, Item)
	...
	local itemname = ""
	if  sc <=30 then	
		GiveItem ( role , 0 , 5644 , 35 , 4 )                    ---------------精灵的鸡腿   获得机率30%
...
function ItemUse_ganjiangbox (role, Item)
	...
	elseif sc <=7001 and sc >3001 then
		GiveItem ( role , 0 , 5645 , 30 , 4 )                    ---------------自动精灵鸡腿   获得机率40%
		GiveItem ( role , 0 , 5913 , 1 , 4 ) 
		itemname = "自动精灵鸡腿"	
...
function ItemUse_taiabox (role, Item)
	...
	elseif sc <=5500 and sc >2500 then		
		GiveItem ( role , 0 , 5643 , 99, 4 )                    ---------------自动加速果   获得机率30%
		GiveItem ( role , 0 , 5916 , 1 , 4 ) 
		itemname = "自动加速果"
...
--	local s = DelBagItem ( role , xxxx , 1 ) 
	...
	local itemname = ""
	if  sc <=30 then	
		GiveItem ( role , 0 , 3094 , 6 , 4 )                    ---------------努力增幅器   获得机率30%
	...
	elseif sc <=75 and sc >45 then
		GiveItem ( role , 0 , 5617 , 1 , 4 )                    ---------------摩力祝福果   获得机率30%
		GiveItem ( role , 0 , 5928 , 1 , 4 ) 
		GiveItem ( role , 0 , 3093 , 1 , 4 ) 
		itemname = "摩力祝福果"
...
function ItemUse_biyudaobox (role, Item)
	...
	elseif sc <=50 and sc >20 then		
		GiveItem ( role , 0 , 0227 , 12 , 4 )                    ---------------守护精灵饲料   获得机率30%
		GiveItem ( role , 0 , 5930 , 1 , 4 ) 
		GiveItem ( role , 0 , 3091 , 1 , 4 ) 
		itemname = "守护精灵饲料"
	elseif sc <=70 and sc >50 then
		GiveItem ( role , 0 , 3096 , 17 , 4 )                    ---------------财富增幅器   获得机率20%
		GiveItem ( role , 0 , 5930 , 1 , 4 ) 
		GiveItem ( role , 0 , 3091 , 1 , 4 ) 
		itemname = "财富增幅器"
...
function ItemUse_libiegoubox (role, Item)
	...
	elseif sc <=60 and sc >40 then
		...
		itemname = "少校之首"
	elseif sc <=90 and sc >60 then
		GiveItem ( role , 0 , 5644 , 15 , 4 )                    ---------------精灵的鸡腿   获得机率30%
		GiveItem ( role , 0 , 5932 , 1 , 4 ) 
		GiveItem ( role , 0 , 3089 , 1 , 4 ) 
		itemname = "精灵的鸡腿"
