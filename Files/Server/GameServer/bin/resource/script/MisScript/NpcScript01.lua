...
function peter_talk001 ()
	...
	Text( 1, "我要填写彩票,别拦我中大奖!", OpenAmphitheater)
...
function arena_talk01 ()
	...
	Text(1, "我要报名参加", JumpPage, 8)
	Text(1, "我要解散队伍", JumpPage, 10)	
	Text(1, "离开", CloseTalk)
	...
	Talk(10, "解散队伍的前提必须是您已经成功报名组建过一支队伍，如果您要解散队伍必须您和您的队友都在同一队伍里，并且要师傅为队长来申请解散队伍，解散后您的队伍将无法参加竞技场比赛，除非再重新组建队伍报名参加")
	InitTrigger()
	--TriggerCondition(1,CheckIsValidTeam)
	TriggerAction(1,ArenaTeamCancel)
	TriggerAction(1,TakeItem,6066,1)
	TriggerFailure(1,JumpPage,9)
	Text(10, "我确定，解散队伍",MultiTrigger, GetMultiTrigger(), 1)
	Text(10, "离开", CloseTalk)
end
