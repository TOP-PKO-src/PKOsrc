...
function after_create_entry(entry) 
    ...
    Notice("海盗广播：有玩家发现，在加纳大陆的["..posx..","..posy.."]位置附近发现一个通往《圣诞村》的入口，该消息尚未核实，请有关单位注意。") --通知本组服务器的所有玩家
...
function after_player_login_07xmas(entry, player_name)
    map_name, posx, posy, tmap_name = GetMapEntryPosInfo(entry) --取地图入口的位置信息（地图名，坐标，目标地图名）
    ChaNotice(player_name, "海盗广播：有玩家发现，在加纳大陆的["..posx..","..posy.."]位置附近发现一个通往《圣诞村》的入口，该消息尚未核实，请有关单位注意。") --通知本组服务器的所有玩家
