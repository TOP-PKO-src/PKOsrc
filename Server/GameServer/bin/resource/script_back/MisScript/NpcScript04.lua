...
function mmm_talk30()
	...
	Talk( 26, "女神：若是你还未完成我给你的任务或者背包满了的话我将无法给你智慧之心！")
	...
	Talk( 32, "你已经完成了我们对你的考验，带上我给你的智慧之心和之前的奉献之心，无畏之心，仁爱之心和火炬回到圣火传递大使那里！")
	InitTrigger()
	TriggerCondition( 1, HasRecord, 1322 )
	TriggerCondition( 1, HasLeaveBagGrid, 1 )
	...
	TriggerFailure( 1, JumpPage, 26 )	
	Text( 32, "好的，我马上就去", MultiTrigger, GetMultiTrigger(), 1 )
	Text( 32, "关闭", CloseTalk )
